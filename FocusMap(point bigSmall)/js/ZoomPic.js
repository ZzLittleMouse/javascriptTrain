...
ZoomPic.prototype = 
{
	initialize : function (id)
	{
        ...
        this.pointSpan = this.pointDiv.getElementsByTagName("span");
		this.pointIndex = 0;//点计数器
    ...
    doPrevPoint:function(){
		//计数器
        this.pointIndex--;
        //重置
        if(this.pointIndex < 0){
            this.pointIndex = this.aLi.length-1;
        }
        this.doFlashPoint();
    },
    doNextPoint:function(){
        ...
        this.pointIndex++;
        //重置
        if(this.pointIndex > this.aLi.length-1){
            this.pointIndex = 0;
        }
		this.doFlashPoint();
    },
	doFlashPoint:function(){
        //设置点的样式
        for(var i=0;i<this.pointSpan.length;i++){
            this.pointSpan[i].className = "";
        }
        this.pointSpan[this.pointIndex].className = "on";
	},
	doPrev : function ()
	{
		this.doPrevPoint();
